...
files="vim vimrc gvimrc bashrc bash_vcs.sh ackrc irbrc screenrc editrc zshrc oh-my-zsh gemrc bash_profile gitignore gitconfig tmux.conf tmuxinator.bash"
