...
files="vim vimrc gvimrc bashrc bash_vcs.sh ackrc irbrc screenrc editrc zshrc gemrc bash_profile gitignore gitconfig"
#files="oh-my-zsh"    # list of files/folders to symlink in homedir
